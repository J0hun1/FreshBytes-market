...
return [
    'category_photos' => [
        ...
        'legumes' => 'https://images.unsplash.com/photo-1586201375761-83865001e17b?auto=format&fit=crop&w=1200&q=80',
    ...
    'recipe_articles' => [
        [
            'slug' => 'monggo-malunggay-soup',
            'title' => 'Monggo with Malunggay',
            'image' => 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=1200&q=80',
            'intro' => 'A comforting Filipino recipe rich in plant protein and leafy micronutrients.',
            'ingredients' => [
                '1 cup monggo beans',
            ...
            'procedure' => [
                'Wash and boil monggo beans until tender.',
                'Saute garlic, onion, and tomato in a pot.',
                'Add cooked monggo and pour in water or stock.',
                'Simmer for 10 minutes, then add malunggay leaves.',
                'Season and serve warm with rice.',
            ],
            'shopping_items' => [
                ['name' => 'Monggo Beans', 'product_name' => 'Monggo Beans', 'quantity' => 1, 'unit' => 'cup', 'note' => 'Main protein base'],
                ['name' => 'Garlic', 'product_name' => 'Garlic', 'quantity' => 3, 'unit' => 'cloves', 'note' => 'Aromatics'],
                ['name' => 'Onion', 'product_name' => 'Onion', 'quantity' => 1, 'unit' => 'piece', 'note' => 'Aromatics'],
                ['name' => 'Kamatis', 'product_name' => 'Kamatis', 'quantity' => 1, 'unit' => 'piece', 'note' => 'Fresh tomato for flavor'],
                ['name' => 'Malunggay / Leafy Greens', 'product_name' => 'Fresh Spinach', 'quantity' => 1, 'unit' => 'bundle', 'note' => 'Substitute if malunggay is unavailable'],
            ],
        ],
        [
            'slug' => 'tinolang-manok-with-papaya',
            'title' => 'Tinolang Manok with Papaya',
            'image' => 'https://images.unsplash.com/photo-1547592166-23ac45744acd?auto=format&fit=crop&w=1200&q=80',
            'intro' => 'Classic Filipino soup with ginger, papaya, and leafy greens for immune support.',
            'ingredients' => [
                '500g chicken pieces',
            ...
            'procedure' => [
                ...
                'Add papaya slices and cook until soft.',
                'Add leafy greens and season before serving.',
            ],
            'shopping_items' => [
                ['name' => 'Chicken', 'product_name' => 'Chicken', 'quantity' => 500, 'unit' => 'g', 'note' => 'Main protein'],
                ['name' => 'Ginger', 'product_name' => 'Ginger', 'quantity' => 1, 'unit' => 'thumb', 'note' => 'Soup aroma'],
                ['name' => 'Onion', 'product_name' => 'Onion', 'quantity' => 1, 'unit' => 'piece', 'note' => 'Aromatics'],
                ['name' => 'Garlic', 'product_name' => 'Garlic', 'quantity' => 2, 'unit' => 'cloves', 'note' => 'Aromatics'],
                ['name' => 'Green Papaya', 'product_name' => 'Papaya', 'quantity' => 1, 'unit' => 'piece', 'note' => 'Tinola staple'],
                ['name' => 'Leafy Greens', 'product_name' => 'Fresh Spinach', 'quantity' => 1, 'unit' => 'bundle', 'note' => 'Good substitute for sili leaves'],
            ],
        ],
        [
            'slug' => 'ensaladang-talbos-kamatis',
            'title' => 'Ensaladang Talbos at Kamatis',
            'image' => 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&w=1200&q=80',
            'intro' => 'A fresh side salad with local greens and tomatoes that is high in antioxidants.',
            'ingredients' => [
                '2 cups talbos or leafy greens',
            ...
            'procedure' => [
                'Blanch greens briefly and drain well.',
                'Combine greens, tomatoes, and onion in a bowl.',
                'Add calamansi juice, salt, and pepper.',
                'Toss gently and serve chilled.',
            ],
            'shopping_items' => [
                ['name' => 'Leafy Greens', 'product_name' => 'Fresh Spinach', 'quantity' => 2, 'unit' => 'cups', 'note' => 'Talbos substitute'],
                ['name' => 'Kamatis', 'product_name' => 'Kamatis', 'quantity' => 2, 'unit' => 'pieces', 'note' => 'Use ripe tomatoes'],
                ['name' => 'Red Onion', 'product_name' => 'Onion', 'quantity' => 1, 'unit' => 'piece', 'note' => 'Half to one onion'],
            ],
        ],
        [
            'slug' => 'ginisang-ampalaya-itlog',
            'title' => 'Ginisang Ampalaya with Egg',
            'image' => 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=1200&q=80',
            'intro' => 'A household Filipino dish that balances bitterness with savory egg protein.',
            'ingredients' => [
                '1 ampalaya, sliced thin',
                '2 eggs, beaten',
                '2 cloves garlic, minced',
                '1 onion, chopped',
                '1 tomato, chopped',
            ...
            'procedure' => [
                'Saute garlic, onion, and tomato in a pan.',
                'Add sliced ampalaya and cook until tender-crisp.',
                'Pour in beaten eggs and stir gently.',
                'Season with salt and serve immediately.',
            ],
            'shopping_items' => [
                ['name' => 'Ampalaya', 'product_name' => 'Ampalaya', 'quantity' => 1, 'unit' => 'piece', 'note' => 'Main vegetable'],
                ['name' => 'Eggs', 'product_name' => 'Eggs', 'quantity' => 2, 'unit' => 'pieces', 'note' => 'Protein component'],
                ['name' => 'Garlic', 'product_name' => 'Garlic', 'quantity' => 2, 'unit' => 'cloves', 'note' => 'Aromatics'],
                ['name' => 'Onion', 'product_name' => 'Onion', 'quantity' => 1, 'unit' => 'piece', 'note' => 'Aromatics'],
                ['name' => 'Kamatis', 'product_name' => 'Kamatis', 'quantity' => 1, 'unit' => 'piece', 'note' => 'Fresh tomato for balance'],
            ],
        ],
    ],
