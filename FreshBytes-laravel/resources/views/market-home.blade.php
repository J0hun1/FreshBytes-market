...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Fredoka:wght@400;500;600;700&family=Freeman&family=Inter:wght@400;500;600;700&family=Montserrat:wght@500;600;700&family=Open+Sans:wght@400;600;700;800&family=Outfit:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
...
<body class="market-page-body">
    ...
    <div class="market-bg-glow market-bg-glow-c"></div>

    <div class="market-page-wrap" id="home">
            ...
            <div class="market-topbar">
                ...
                <div class="market-actions">
                    <a href="#nutritional-products" aria-label="Nutrition">
                        <svg viewBox="0 0 24 24"><path d="M6 2h9a3 3 0 013 3v15a2 2 0 01-2 2H6a3 3 0 01-3-3V5a3 3 0 013-3zm0 2a1 1 0 00-1 1v14a1 1 0 001 1h10V5a1 1 0 00-1-1H6z"/></svg>
                        <span>Nutrition</span>
                    </a>
                    <a href="#recommended-bites" aria-label="Notifications">
                        <svg viewBox="0 0 24 24"><path d="M12 2a6 6 0 016 6v3.59l1.7 2.54A1 1 0 0118.87 16H5.13a1 1 0 01-.83-1.87L6 11.59V8a6 6 0 016-6zm0 20a3 3 0 002.83-2h-5.66A3 3 0 0012 22z"/></svg>
                        <span>Notifications</span>
                    </a>
                    <a href="#fresh-near-you" aria-label="Wishlist">
                        <svg viewBox="0 0 24 24"><path d="M12 21s-7-4.35-7-10a4 4 0 017-2.65A4 4 0 0119 11c0 5.65-7 10-7 10z"/></svg>
                        <span>Wish. list</span>
                    </a>
                    <a href="{{ route('cart.index') }}" aria-label="Cart">
                        <svg viewBox="0 0 24 24"><path d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13l-1 5h12M9 20a1 1 0 102 0 1 1 0 00-2 0zm8 0a1 1 0 102 0 1 1 0 00-2 0z"/></svg>
                        <span>Cart</span>
                    </a>
                    @auth
                        <form action="{{ route('auth.logout') }}" method="post" class="market-account-form">
                            ...
                            <button type="submit" aria-label="Logout">
                                <svg viewBox="0 0 24 24"><path d="M10 3h7a2 2 0 012 2v14a2 2 0 01-2 2h-7v-2h7V5h-7V3zm-1 4l-1.41 1.41L10.17 11H3v2h7.17l-2.58 2.59L9 17l5-5-5-5z"/></svg>
                                <span>Logout</span>
                            </button>
                        </form>
                    @else
                        <a href="{{ route('auth.login') }}" aria-label="My Account">
                            <svg viewBox="0 0 24 24"><path d="M12 12a5 5 0 100-10 5 5 0 000 10zm0 2c-4.42 0-8 2.24-8 5v1h16v-1c0-2.76-3.58-5-8-5z"/></svg>
                    ...
                    @foreach(['/images/nutritional_1.png', '/images/nutritional_2.png', '/images/nutritional_3.png', '/images/nutritional_4.png'] as $img)
                        <article class="market-article-card">
                            ...
                            <div class="market-article-body">
                                ...
                                <p>This refreshing and nutrient-packed salad combines vibrant vegetables, hearty chickpeas, and a zesty lemon-olive oil dressing. Perfect for a light lunch or a side dish, loaded with fiber, protein, and healthy fats.</p>
